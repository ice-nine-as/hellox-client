(function () {
  ...
  var loadFullFonts = function (subsetSuccess) {
    ...
    var latoLight   = new FontFaceObserver('Lato Light');
    var latoItalic  = new FontFaceObserver('Lato Italic');
    var promises = [
      loadSingleFont(latoRegular),
      loadSingleFont(latoBold),
      loadSingleFont(latoLight),
