...
// @ts-ignore
import _styles from '../Styles/Pages/PrivacyPolicy.less';
const styles = _styles || {};

export class PrivacyPolicy extends React.PureComponent {
  render() {
    return (
      <div className={`${styles.PrivacyPolicy} ${styles.Page}`}>
        <div className={styles.Content}>
          ...
          <p>
            Your privacy is important to us. It is Ice-9's policy to respect
            your privacy regarding any information we may collect from you
            across our website, <a href="https://hellox.me">https://hellox.me</a>,
          ...
          <ul>
            <li>
              ...
              a party or to take steps at your request before entering into
              such a contract (for example, when we provide a service you
              request from us);
            </li>
          ...
          <p>
            ...
            time (but this will not affect any processing that has already taken place).
          </p>
          ...
          <p>
            ...
            said, we advise that no method of electronic transmission or
            storage is 100% secure and cannot guarantee absolute data security.
            If necessary, we may retain your personal information for our
            compliance with a legal obligation or in order to protect your
          ...
          <ul>
            <li>
              ...
              collectors, maintenance or problem-solving providers, marketing
              or advertising providers, professional advisors and payment
              systems operators;
            </li>
          ...
          <p>
            ...
            Norway, or where we or our partners, affiliates and third-party
          ...
          <p>
            <strong>
              Choice and consent:
            </strong> By providing personal information to us, you consent to us
            collecting, holding, using and disclosing your personal information
            in accordance with this privacy policy. If you are under 16 years
            of age, you must have, and warrant to the extent permitted by law
            ...
            consented to you providing us with your personal information. You
            do not have to provide personal information to us, however, if you
            do not, it may affect your use of this website or the products
          ...
          <p>
            ...
            </strong> If we receive personal information about you from a third party, we
          ...
          <p>
            <strong>
              Restrict:
            </strong> You may choose to restrict the collection or use of your personal
          ...
          <p>
            ...
            </strong>  You may request details of the personal information that we hold
          ...
          <p>
            <strong>
              Correction:
            </strong> If you believe that any information we hold about you is
          ...
          <p>
            ...
            </strong> We will comply laws applicable to us in respect of any data breach.
          </p>

          <p>
            <strong>
              Complaints:
            </strong>  If you believe that we have breached a relevant data protection law
            ...
            we will take to deal with your complaint. You also have the right
          ...
          <p>
            <strong>
              Unsubscribe:
            </strong> To unsubscribe from our e-mail database or opt-out of
          ...
          <p>
            ...
            stores on your computer, and accesses each time you visit, so we
            can understand how you use our site. This helps us serve you
