...
export const storyTemplateEnFeedReducer: TReducer<IRssFeed | null, IRssAction> = (
  ...
  action: IRssAction): IRssFeed | null =>
{
  ...
  if (isRssAction(action) && action.feedKey === FeedKeys.StoryTemplateEn) {
    return action.value;
  }
...
export default storyTemplateEnFeedReducer;