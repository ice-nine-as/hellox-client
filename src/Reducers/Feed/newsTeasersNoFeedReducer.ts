...
export const strings = {
  PREVIOUS_STATE_INVALID:
    'The previousState argument passed to the newsTeasersNoFeedReducer ' +
    'function was not null, nor did it meet the isRssFeed type guard.',
};

export const newsTeasersNoFeedReducer: TReducer<IRssFeed | null, IRssAction> = (
  ...
  if (isRssAction(action) && action.feedKey === FeedKeys.NewsTeasersNo) {
    return action.value;
  }
...
export default newsTeasersNoFeedReducer;