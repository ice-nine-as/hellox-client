...
export const strings = {
  PREVIOUS_STATE_INVALID:
    'The previousState argument passed to the newsFullNoFeedReducer ' +
    'function was not null, nor did it meet the isRssFeed type guard.',
};

export const newsFullNoFeedReducer: TReducer<IRssFeed | null> = (
  ...
  if (isRssAction(action) && action.subtype === RssActionSubtypes.NewsFullNo) {
    return action.value;
  }
...
export default newsFullNoFeedReducer;