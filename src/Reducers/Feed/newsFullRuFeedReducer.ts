...
export const strings = {
  PREVIOUS_STATE_INVALID:
    'The previousState argument passed to the newsFullRuFeedReducer ' +
    'function was not null, nor did it meet the isRssFeed type guard.',
};

export const newsFullRuFeedReducer: TReducer<IRssFeed | null, IRssAction> = (
  ...
  if (isRssAction(action) && action.feedKey === FeedKeys.NewsFullRu) {
    return action.value;
  }
...
export default newsFullRuFeedReducer;