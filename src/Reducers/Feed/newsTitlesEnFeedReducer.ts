...
export const strings = {
  PREVIOUS_STATE_INVALID:
    'The previousState argument passed to the newsTitlesEnFeedReducer ' +
    'function was not null, nor did it meet the isRssFeed type guard.',
};

export const newsTitlesEnFeedReducer: TReducer<IRssFeed | null, IRssAction> = (
  ...
  if (isRssAction(action) && action.feedKey === FeedKeys.NewsTitlesEn) {
    return action.value;
  }
...
export default newsTitlesEnFeedReducer;