...
export const strings = {
  PREVIOUS_STATE_INVALID:
    'The previousState argument passed to the newsTitlesNoFeedReducer ' +
    'function was not null, nor did it meet the isRssFeed type guard.',
};

export const newsTitlesNoFeedReducer: TReducer<IRssFeed | null, IRssAction> = (
  ...
  if (isRssAction(action) && action.feedKey === FeedKeys.NewsTitlesNo) {
    return action.value;
  }
...
export default newsTitlesNoFeedReducer;